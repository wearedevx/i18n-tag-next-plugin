...
var Link = function Link(_ref) {
  ...
  return React.createElement(_link["default"], newProps, React.createElement("a", {
    href: newProps.href,
    className: className
  }, children));
};

Link.propTypes = _objectSpread({}, _link["default"].propTypes, {
